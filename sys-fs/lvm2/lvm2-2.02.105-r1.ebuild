...
EAPI=5
inherit autotools eutils linux-info multilib systemd toolchain-funcs flag-o-matic
...
IUSE="readline static static-libs clvm cman lvm1 lvm2create_initrd selinux  +thin device-mapper-only"
