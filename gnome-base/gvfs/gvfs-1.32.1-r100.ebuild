...
IUSE="afp archive bluray cdda fuse google gnome-keyring gnome-online-accounts gphoto2 gtk +http ios mtp nfs olde-gentoo policykit samba systemd test udev udisks zeroconf"
REQUIRED_USE="
	!olde-gentoo? (
		cdda? ( udev )
		mtp? ( udev )
