...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.16.0.ebuild,v 1.1 2014/07/17 17:12:50 mattst88 Exp $
...
IUSE="${IUSE_SERVERS} glamor ipv6 minimal nptl selinux +suid systemd tslib unwind wayland"
